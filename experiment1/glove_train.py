...
import gloveloader as loader
from gloveloader import SpellingDataset
...
class SpellingModel(nn.Module):
    def __init__(self):
        ...
        if params.have_char_embeds:
            ...
            trained_embeddings = torch.tensor(loader.glove.T[0:].values).to(torch.float32).T[:loader.glove_size+10, :]
